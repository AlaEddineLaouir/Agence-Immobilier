...
<div class="wrap-login100">
	...
	<form id="form-profile" class="login100-form validate-form" method="POST" action="Agent" style="height: 100%;">
	    ...
	    <div class="wrap-input100 validate-input" data-validate = "Entrer votre nom">
	        <input class="input100 has-val" type="text" name="nom" value="<% out.print(A.getNom()); %>" readonly>
	    ...
	    <div class="wrap-input100 validate-input" data-validate = "Entrer votre prenom">
	        <input class="input100 has-val" type="text" name="prenom" value="<% out.print(A.getPrenom()); %>" readonly>
	    ...
	    <div class="wrap-input100 validate-input" data-validate = "Entrer votre date de naissance">
	        <input class="input100 has-val notempty" type="date" name="naissance" value="<% out.print(A.getNaissance()); %>" readonly>
	    ...
	    <div class="wrap-input100 validate-input" data-validate = "Entrer votre adresse">
	        <input class="input100 has-val" type="text" id="adresse" name="adresse"  value="<% out.print(A.getAdresse()); %>" readonly>
	    ...
	    <div class="wrap-input100 validate-input" data-validate = "Entrer votre email forme 'a@b.c'">
	        <input class="input100 has-val" type="email" id="email" name="email" value="<% out.print(A.getEmail()); %>" readonly>
	        <span class="focus-input100" data-placeholder="email"></span>
	    </div>
	    <p class="email erreur"></p>
	    <div class="wrap-input100 validate-input" data-validate = "Entrer votre numero de telephone">
	        <input class="input100 has-val" type="number" min="0" id="telephone" name="telephone" value="<% out.print(A.getTelephone()); %>" readonly>
	    ...
	    <div class="wrap-input100 validate-input" data-validate = "Entrer votre numéro d'identité">
	        <input class="input100 has-val" type="number" min="0" name="identite" value="<% out.print(A.getIdentite()); %>" readonly>
        ...
        <div class="wrap-input100 validate-input" data-validate = "Entrer le nom d'utilisateur">
            <input class="input100 has-val" type="text" id="utilisateur" name="utilisateur" value="<% out.print(A.getUtilisateur()); %>" readonly>
        ...
        <div class="wrap-input100 validate-input" data-validate="Entrer le mot de passe">
            ...
            <input class="input100 has-val" type="password" id="passe" name="passe" value="<% out.print(A.getPasse()); %>" readonly>
