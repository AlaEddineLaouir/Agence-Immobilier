...
<table class="table-rdv">
	...
	<tbody class="<%out.print("rdv"+i);%>">
	    <tr>
	        ...
	        <td data-label="Date de RDV"><input class="dateRDV" type="text" name="dateRDV" value="<%out.print(RDVs.get(i).getDateRDV());%>" readonly></td>
	        ...
	        <td data-label="Moyenne de contact"><input class="contact" type="text" name="contact" value="<%out.print(RDVs.get(i).getContact());%>" readonly></td>
...
<script type="text/javascript">
	...
	annuler.click(function(){
		$('.'+this.getAttribute("form")+' .dateRDV').attr("readonly","readonly");
		$('.'+this.getAttribute("form")+' .heureRDV').attr("readonly","readonly");
		
		$('.'+this.getAttribute("form")+' .editer').hide();
		$('.'+this.getAttribute("form")+' .modifier').show();
		$('.'+this.getAttribute("form")+' .annuler').hide();
		$('.'+this.getAttribute("form")+' .supprimer').show();
	});
