						...
						<article class="material-card Blue-Grey">
							...
							<div class="mc-content">
								...
								<div class="mc-description">
									...
									<form>
										<input id="louerappartement<%out.print(i);%>" value="<%out.print(appartements.get(i).getId());%>" hidden>
										<button class="louer" name="louerappartement<%out.print(i);%>">Louer</button>
										<input id="visiterappartement<%out.print(i);%>" value="<%out.print(appartements.get(i).getId());%>" hidden>
										<button class="visiter" name="visiterappartement<%out.print(i);%>">Visiter</button>
									</form>
								</div>
							</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<article class="material-card Blue-Grey">
							...
							<div class="mc-content">
								...
								<form>
									<input id="louerlocale<%out.print(i);%>" value="<%out.print(locales.get(i).getId());%>" hidden>
									<button class="louer" name="louerlocale<%out.print(i);%>">Louer</button>
									<input id="visiterlocale<%out.print(i);%>" value="<%out.print(locales.get(i).getId());%>" hidden>
									<button class="visiter" name="visiterlocale<%out.print(i);%>">Visiter</button>
								</form>
							</div>
						</div>
						<a class="mc-btn-action">
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<article class="material-card Blue-Grey">
							...
							<div class="mc-content">
								...
								<form>
									<input id="louerterrain<%out.print(i);%>" value="<%out.print(terrains.get(i).getId());%>" hidden>
									<button class="louer" name="louerterrain<%out.print(i);%>">Louer</button>
									<input id="visiterterrain<%out.print(i);%>" value="<%out.print(terrains.get(i).getId());%>" hidden>
									<button class="visiter" name="visiterterrain<%out.print(i);%>">Visiter</button>
								</form>
							</div>
						</div>
						<a class="mc-btn-action">
						...
						<article class="material-card Blue-Grey">
							...
							<div class="mc-content">
								...
								<div class="mc-description">
									...
									<form>
										<input id="louervilla<%out.print(i);%>" value="<%out.print(villas.get(i).getId());%>" hidden>
										<button class="louer" name="louervilla<%out.print(i);%>">Louer</button>
										<input id="visitervilla<%out.print(i);%>" value="<%out.print(villas.get(i).getId());%>" hidden>
										<button class="visiter" name="visitervilla<%out.print(i);%>">Visiter</button>
									</form>
								</div>
							</div>
							<a class="mc-btn-action">
...
$('.louer').click(function (e) {
	e.preventDefault();
	$('.louerBien').show();
	$('.louerBien #bien').val($('#'+this.getAttribute("name"))[0].value);
});
$('.visiter').click(function (e) {
	e.preventDefault();
	$('.visiterBien').show();
	$('.visiterBien #bien').val($('#'+this.getAttribute("name"))[0].value);
});
</script>